...
#'   \item{rxErrseq}{a vector of error flags in the path of selecting rx.
#'                   For each element, 0 indicates no error.}
#'   \item{ryErrseq}{a vector of error flags in the path of selecting ry.
#'                   For each element, 0 indicates no error.}
#'   \item{rErrseq}{a vector of error flags in the path of selecting r.
#'                   For each element, 0 indicates no error.}
#'
#' @details
